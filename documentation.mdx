...
<Steps>
  ...
  <Step title="Link pages">
    Link to whichever documentation pages you want in your navigation by editing the `docs.json`
    file.

    <Accordion icon='code' title='View navigation example'>
      Here's how we link from
      [our file](https://github.com/agentfirstdev/doc/blob/main/docs.json#L13-L50):
