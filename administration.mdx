...
**Agent First's** administration service lets you support your whitelabel customers. The service has
a RESTful interface that accepts `GET`, `POST`, and `PATCH` requests at
**https://&zwj;api.agentfirst.dev/users**.
...
The user's secret API token will be returned, along with their normalized email address and service
permissions:
