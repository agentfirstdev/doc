...
import { apiEndpoint } from '/snippets/config.mdx';
import SearchMode from '/snippets/search/mode.mdx';
import BrowserMode from '/snippets/browser/mode.mdx';
import Results from '/snippets/search/results.mdx';
import Content from '/snippets/browser/content.mdx';
