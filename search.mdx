...
Searches are performed in real time by default or can be queued for [later retrieval](scheduling).
...
Besides the [geotargeting and scheduling parameters](#usage) linked to above, required and optional
