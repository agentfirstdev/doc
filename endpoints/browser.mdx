...
| `speed`      | ⬜       | The target speed to browse at, `light`, `ridiculous`, or `ludicrous` (planned), where `ridiculous` is N percent faster on average than `light`; `light` is the default speed                                                                        |
