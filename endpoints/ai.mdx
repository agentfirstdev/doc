...
They're had live by default or optionally queued for <Link href='scheduling'>subsequent
...
[geotargeting keys and values](#usage) above and following chat keys and values:

| Key                  | Value                                                                                                                                                                                                                                                                                                                                                  |
| :------------------- | :------------------------------------------------------------------------------------------------------------- |
| `model`              | The AI model that responded                                                                                    |
| `prompt`             | The user prompt that was responded to                                                                          |
...
| `queries`            | An array of the fanout queries that the model searched while responding; only some models expose these queries |
