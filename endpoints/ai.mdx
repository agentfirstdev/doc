...
[geotargeting keys and values](#usage) above and the following chat keys and values:

| Key                  | Value                                                                                                                                                                                                                                                                                                                                                  |
| :------------------- | :-------------------------------------------------------------------------------------------------------------------------- |
| `model`              | The AI model that generated the response                                                                                    |
| `prompt`             | The user prompt that was given                                                                                              |
...
| `queries`            | An array of the fanout search queries that the model used to generate the completion; only some models expose these queries |
| `device` (planned)   | The emulated device name that the conversation was had on                                                                   |
| `language` (planned) | The commonly spelled name or two-letter ISO code of the language that the conversation is in                                |
| `display` (planned)  | The commonly spelled name or two-letter ISO code of the display language that conversation interface is in                  |
