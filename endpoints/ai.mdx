...
[geotargeting keys and values](#usage) linked above and these AI keys and values:

| Key                  | Value                                                                                                                                                                                                                                                                                                                                                  |
| :------------------- | :----------------------------------------------------------------------------------------------------------------------------------------- |
| `model`              | The AI model that was conversed with                                                                                                       |
| `prompt`             | The chat prompt that was used                                                                                                              |
| `html`               | The rendered HTML of the entire conversation                                                                                               |
| `promptHtml`         | The rendered HTML of the prompt portion of the conversation                                                                                |
| `completionHtml`     | The rendered HTML of the completion portion of the conversation                                                                            |
| `sourcesHtml`        | The rendered HTML of the sources portion of the conversation                                                                               |
| `fanoutQueries`      | An array of the fanout search queries, if any, that the model performed to generate the completion; only some models expose fanout queries |
| `device` (planned)   | The emulated device name that the conversation was on                                                                                      |
| `language` (planned) | The commonly spelled name or two-letter ISO code of the language that the conversation is in                                               |
| `display` (planned)  | The commonly spelled name or two-letter ISO code of the display language that chat interface is in                                         |
