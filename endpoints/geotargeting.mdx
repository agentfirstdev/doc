...
| Key           | Value                                                                                             |
| :------------ | :------------------------------------------------------------------------------------------------ |
| `country`     | The ISO code of the country that the content was browsed from                                     |
| `subdivision` | The partial ISO code of the targeted subdivision in the country that the content was browsed from |
| `city`        | The common name of the targeted city in the country that the content was browsed from             |
