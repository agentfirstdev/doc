...
Webpages can be routed with [geotargeting parameters](geotargeting). They’re retrieved in real time
by default or optionally queued for [later retrieval](scheduling). Up to **120 seconds** is allotted
per real-time API request to accommodate CAPTCHA-solving, multiple retries, and other mitigations.
