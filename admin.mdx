...
You can provision a user by specifying their email address and, optionally, initial API credits:
...
| `credits` |          | The number of API credits to seed the account with                                                                                                        |
...
| `credits` | The initial number of API credits granted to the account         |

### Customer deactivation

Disable an account with just the account's email address:
